...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thien Nhan Hub ⚜️ chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đăng ký kênh Nzix Roblox để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Thien Nhan Hub ⚜️", HidePremium = false, IntroText = "Thien Nhan Hub ⚜️⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Thien Nhan Hub ⚜️",
    Content = "Please Wait loading script...,Do not enable any function",
    Image = "rbxassetid://18167842999",
    Time = 5
})
wait(3)
OrionLib:MakeNotification({
...
W:AddLabel("Thien Nhan Hub ⚜️ SCRIPT")
W:AddLabel("DiscordThien Nhan Hub ⚜️")
local Section = W:AddSection({
    Name = "Status"
})
...
C:AddButton({
    ...
    Callback = function(value)
        setclipboard("https://discord.com/invite/BtCec2fPqg")
    end
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Thien Nhan Hub ⚜️(Noitification)",
